...
export class Terrain {
    private readonly space: cp.Space;
    private shapes: Array<cp.SegmentShape>;

    private readonly components: Array<any>;
